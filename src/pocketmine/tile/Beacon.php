...
use pocketmine\scheduler\BeaconCheckTask;
...
class Beacon extends Spawnable implements Nameable, InventoryHolder {
	...
	public function onUpdate() {
		...
		$this->getLevel()->getServer()->getScheduler()->scheduleDelayedTask(new BeaconCheckTask($this, $this->getLevel()->getId()), 20 * 4);//4 seconds
	}
